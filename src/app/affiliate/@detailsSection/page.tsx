      ...
      <div className="w-[360px] mx-auto lg:w-auto ">
        ...
        <section className="mt-8 flex flex-col gap-[52px] w-[300px] mx-auto lg:flex-row lg:w-auto lg:gap-0 lg:justify-around lg:px-4 xl:justify-center xl:gap-20 xl:mt-[87.5px] ">
          ...
          <section className="lg:basis-1/3 xl:w-[269px] xl:basis-auto ">
            ...
            <div className="mt-2 w-[145px] mx-auto text-[16px] font-[600] leading-[19.2px] text-[#4D1435] text-center xl:mt-4 xl:text-2xl xl:leading-[28.8px] xl:w-auto ">
              Empower Parents & Build Trust
            </div>

            <div className="mt-2 w-[276px] mx-auto text-center text-[14px] font-[400] leading-[19.6px] text-[#4D1435] xl:mt-4 xl:text-lg xl:leading-[25.2px] xl:px-0 ">
          ...
          <section className="lg:basis-1/3 xl:w-[300px] xl:basis-auto ">
            ...
            <div className="mt-2 mx-auto text-[16px] font-[600] leading-[19.2px] text-center text-[#4D1435] xl:mt-4 xl:text-2xl xl:leading-[28.8px] xl:w-auto ">
              Earn up to ₹90,000 for every Successful Referral
            </div>

            <div className="w-[300px] mx-auto mt-2 px-4 text-[14px] font-[400] leading-[19.6px] text-[#4D1435] text-center xl:mt-4 xl:text-lg xl:leading-[25.2px] xl:px-0 ">
          ...
          <section className="lg:basis-1/3 xl:w-[300px] xl:basis-auto ">
            ...
            <div className="mt-2 mx-auto px-16 text-[16px] font-[600] leading-[19.2px] text-center text-[#4D1435] xl:mt-4 xl:text-2xl xl:leading-[28.8px] xl:w-auto xl:px-0 xl:text-balance ">
