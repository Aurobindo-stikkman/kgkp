    ...
    <section className="mt-11 flex flex-col sm:justify-center lg:mt-[75px] lg:flex-row lg:gap-16 2xl:gap-24 ">
        ...
        >
          <g clip-path="url(#clip0_2257_5319)">
            ...
            <mask
              ...
              height="483"
            >
              <path d="M654.996 0H-202.381V482.274H654.996V0Z" fill="white" />
            </mask>
      ...
      <section className="lg:basis-1/2 lg:relative">
        ...
        <section className="mt-8 text-[14px] font-[400] leading-[22.4px] text-[#4D1435] mx-4 lg:w-[545px] xl:mt-6 xl:text-[16px] xl:leading-[25.6px] xl:inline-block ">
          ...
          Milestones Acceleration, Theory of Multiple Intelligences and so on to
          boost your child’s intellectual abilities. The program also enhances
          emotional and spiritual quotients through guided parenting practices,
          storytelling, and regular sessions on various relevant topics.
          <div className="mt-6 xl:text-[16px] xl:leading-[25.6px]">
            KGKP’s holistic and time-tested method ensures comprehensive
            personality development, fostering academic excellence, emotional
            intelligence, and a balanced, peaceful lifestyle.
          </div>
        </section>
      </section>
    </section>
