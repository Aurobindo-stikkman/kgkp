  ...
  return (
    <section className="h-[412px] relative pt-[52px] bg-[#75C0B1] lg:h-[667px] lg:pt-[124px] ">
      <section className="pl-[47px] pr-[66px] text-center text-[#1A2434] relative text-[20px] font-[700] leading-[28.6px] lg:text-[32px] lg:font-[700] lg:leading-[38.4px] lg:w-[645px] lg:p-0 lg:mx-auto">
        <span
          ref={chalkStrokeRef}
          className="z-10 relative w-[247px] mx-auto block lg:w-auto max-w-[627px] "
        >
          Real Experiences: Parents Testimonials and Child Outcomes
        </span>
        <svg
          className={`absolute w-[178.08px] h-[33px] left-[48%] -bottom-4 translate-x-[-50%] z-0 lg:bottom-[-18px] lg:left-[54%] lg:w-[293.11px] lg:h-[35px] ${
        ...
        >
          ...
          <path
            ...
            strokeWidth="3"
            strokeLinecap="butt"
            clipPath="url(#home-testimonials)"
      ...
      >
        ...
        <div className="carousel w-full h-full flex overflow-x-scroll gap-3 px-4 lg:justify-around lg:h-[352px] lg:items-center lg:overflow-hidden xl:gap-[112px] xl:justify-center ">
          ...
          >
            ...
            <section className="text-[13.24px] font-normal opacity-[70%] tracking-[0.4px] leading-[18.53px] text-[#1A2434] ">
