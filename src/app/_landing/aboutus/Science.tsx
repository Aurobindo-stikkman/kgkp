...
const Science = () => {
  ...
  return (
    <div className="relative bg-[#F6E2D7] rounded-[40px] py-[52px] lg:py-[124px] lg:rounded-[100px]">
      <section
        ref={chalkStrokeRef}
        className="text-[20px] font-[700] relative leading-[28.6px] text-[#460C04] w-[178px] h-[29px] mx-auto lg:text-[32px] lg:leading-[38.4px] lg:w-[285px]"
      >
        ...
        >
          <defs>
            <clipPath id="home-about-science">
              <rect
                id="clipRect"
                x="0"
                y="0"
          ...
          <path
            ...
            strokeWidth="3"
            strokeLinecap="butt"
            clipPath="url(#home-about-science)"
