...
import trophy from "./assets/success-story/trophy.svg";
...
const SuccessStory = () => {
  return (
    <section className="bg-[#4D1435] pt-[62px] pb-[52px] relative lg:overflow-x-hidden lg:py-[124px] xl:pt-[160px]">
      ...
      <section className="flex flex-col gap-[6px] lg:flex-row lg:w-[650px] lg:mx-auto justify-center xl:w-[681px]">
        <div className="w-[164px] text-[20px] font-[700] leading-[24px] text-[#F6E2D8] mx-auto h-6 lg:w-auto lg:mx-0 lg:text-[24px] lg:leading-[30.4px] xl:text-[32px] xl:leading-[38.4px]">
          Success Stories:
        </div>
        <div className="w-[258px] text-[20px] font-[700] leading-[24px] text-[#F6E2D8] relative mx-auto h-6 lg:mx-0 lg:w-auto lg:text-[24px] lg:leading-[30.4px] xl:text-[32px] xl:leading-[38.4px]">
          <span className="z-10 relative">Hear from our First Genius</span>

          <svg
            className="absolute w-[141.08px] h-[60.94px] top-[-6px] right-[-2px] z-0 lg:w-[227.4px] lg:h-[93.76px] lg:top-[-14px] lg:right-[-14px] xl:w-[309.4px] xl:-top-1 xl:-right-6 "
            viewBox="0 0 345 41"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      {/* Video section */}
      <section className="flex flex-col items-center md:flex-row md:p-4 lg:px-[100px] lg:mt-[140px] lg:gap-16 xl:mt-[160px] xl:mx-auto xl:w-fit xl:gap-[128px] ">
        <section className="w-[328px] h-auto rounded-[24.56px] mt-8 mx-auto border border-[transparent] md:basis-1/2 md:h-[250px] lg:w-[520px] lg:basis-auto lg:h-[300px] xl:w-[520px] xl:flex-shrink-0 xl:basis-[520px] xl:h-[329px] xl:rounded-[40px]">
          <div className="relative h-full w-full z-10">
            ...
            <Image
              src={vector12}
              alt="Vector 12"
              className="hidden xl:block w-[376.66px] h-[403.91px] absolute -z-10 top-[-44px] left-[-17px]"
            />
            <Image
              src={vector13}
              alt="Vector 13"
              className="hidden xl:block w-[332.66px] h-[429.91px] absolute -z-10 top-[-57px] left-[87px]"
            />
          </div>
        </section>

        <section className="italic text-[17px] font-[500] leading-[21.8px] text-[#F6E2D8] text-center w-[328px] mx-4 relative mt-[54px] font-inter md:basis-1/2 lg:text-left xl:w-[508px] max-w-[508px] xl:h-[120px] xl:mx-0 xl:text-[20px] xl:leading-[24px] ">
          ...
          <svg
            className="w-8 h-[125px] absolute top-[-86px] left-0 lg:-top-16 lg:-left-10 "
            width="40"
            height="35"
            viewBox="0 0 40 35"
            fill="none"
          ...
          >
            <path
              fill="#7C4E63"
              d="M14.56 0.259994C15.8667 1.19333 16.52 2.12666 16.52 3.06C16.52 3.71333 16.1933 4.27333 15.54 4.73999C13.1133 7.26 11.3867 9.5 10.36 11.46C9.33333 13.3267 8.82 15.0067 8.82 16.5C8.82 18.46 9.52 20.0467 10.92 21.26C12.4133 22.38 13.9533 23.3133 15.54 24.06C16.8467 24.5267 17.5 25.5067 17.5 27C17.5 28.12 17.0333 29.38 16.1 30.78C15.26 32.18 13.9067 33.4867 12.04 34.7C8.96 33.7667 6.20667 32.1333 3.78 29.8C1.35333 27.4667 0.14 24.5267 0.14 20.98C0.14 18.0867 1.21333 14.9133 3.36 11.46C5.50667 7.91333 9.24 4.17999 14.56 0.259994ZM36.82 0.259994C38.1267 1.19333 38.78 2.12666 38.78 3.06C38.78 3.80666 38.5 4.36666 37.94 4.73999C35.42 7.26 33.6467 9.5 32.62 11.46C31.5933 13.3267 31.08 15.0067 31.08 16.5C31.08 18.46 31.78 20.0467 33.18 21.26C34.6733 22.38 36.2133 23.3133 37.8 24.06C39.2 24.5267 39.9 25.5067 39.9 27C39.9 28.12 39.4333 29.38 38.5 30.78C37.5667 32.18 36.1667 33.4867 34.3 34.7C31.22 33.7667 28.4667 32.1333 26.04 29.8C23.6133 27.4667 22.4 24.5267 22.4 20.98C22.4 18.0867 23.4733 14.9133 25.62 11.46C27.86 7.91333 31.5933 4.17999 36.82 0.259994Z"
            />
          </svg>
        </section>
      </section>
      ...
      <Image
        src={trophy}
        alt="Trophy image"
        className="hidden lg:block absolute -right-3 top-3 h-[283.56px] w-[197px] "
      />
    </section>
  );
};
