...
const AboutFounder = () => {
  ...
  // Set the fill color based on `isMobile`
  const fillColor = isMobile ? "#FFB31F" : "#F6D94A";

  return (
    <div className="bg-[#75C0B1] rounded-[40px] px-4 py-[52px] lg:py-[124px] lg:px-[81px] lg:rounded-[100px] ">
      <section className="relative w-max text-[28px] font-[700] leading-[36.4px] text-[#1A2434] mx-auto text-center lg:text-[42px] lg:leading-[50.4px]">
        <span ref={chalkStrokeRef} className="relative z-10">
          Our Founder & CEO
        </span>
        <svg
          className={`absolute w-[222.08px] h-[60.94px] left-[60%] top-1 translate-x-[-50%] z-0 lg:left-[53%] lg:top-[10%] lg:w-[359.11px] lg:h-[93.76px] ${
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            style={{ fill: fillColor }} // Dynamically apply the color
            stroke="transparent"
            strokeWidth="3"
            strokeLinecap="butt"
            clipPath="url(#about-founder)"
      ...
      <section className="mt-8 text-[18px] font-[600] leading-[21.6px] text-[#1A2434] mx-auto text-center lg:hidden">
        Mr. Ramesh Chandra Partani
      </section>

      <section className="flex flex-col gap-[49px] lg:mt-[86px] lg:gap-0 lg:items-center lg:flex-row-reverse lg:justify-between max-w-[1278px] xl:gap-[84px] xl:mx-auto">
        <section
          style={{ borderRadius: "40% 60% 63% 37% / 26% 66% 34% 74%" }}
          className="mt-8 bg-[#A16E5738] h-[257px] w-[251.79px] p-4 mx-auto lg:mx-0 lg:basis-[470px] flex-shrink-0 lg:h-[443px] lg:p-6 xl:p-8 xl:basis-[532px] xl:h-auto xl:relative"
        >
          <Image
            src={rameshPartani}
            alt="Ramesh Partani"
          ...
          <Image
            src={pointingArrow}
            alt="Pointing arrow"
            className="hidden xl:block w-[234.43px] h-[234.43px] absolute left-[-114px] top-[-130px]"
          />
        </section>

        <section className="mx-auto lg:mx-0 lg:pr-6 xl:pr-0">
          <section className="hidden lg:block w-auto lg:text-[27px] font-[600] text-[#1A2434] lg:leading-[43.2px] xl:text-[36px]">
            Mr. Ramesh Chandra Partani
          </section>
          <section className="w-[328px] text-[14px] font-[400] leading-[19.6px] text-[#1A2434] lg:w-auto lg:mt-4 max-w-[661px] text-justify xl:text-[20px] xl:leading-[28px]">
          ...
          <section
            className={`w-[328px] text-[14px] font-[400] leading-[19.6px] text-[#1A2434] mt-3 text-justify lg:w-auto max-w-[661px] xl:text-[20px] xl:leading-[28px] ${
              !isMobile
                ? "h-auto"
                : isOpen
                ? "h-auto"
      ...
      {(!isMobile || isOpen) && (
        <section className="w-[328px] mx-auto lg:w-auto max-w-[1278px]">
