  ...
  return (
    <div className="bg-[#75C0B1] rounded-[40px] px-4 py-[52px] lg:py-[124px] lg:px-[81px] lg:rounded-[100px] ">
      <section className="relative text-[28px] font-[700] leading-[36.4px] text-[#1A2434] mx-auto text-center lg:text-[42px] lg:leading-[50.4px]">
        ...
        <svg
          className="absolute w-[222.08px] h-[60.94px] left-[53%] top-1 translate-x-[-50%] z-0 lg:left-[53%] lg:top-[10%] lg:w-[359.11px] lg:h-[93.76px]"
          viewBox="0 0 345 41"
          fill="none"
      ...
      <section className="flex flex-col gap-[49px] lg:mt-[86px] lg:gap-0 lg:items-center lg:flex-row-reverse lg:justify-between max-w-[1278px] xl:gap-[84px] xl:mx-auto">
        ...
        <section className="mx-auto lg:mx-0 lg:pr-6 xl:pr-0">
          <section className="hidden lg:block w-auto lg:text-[27px] font-[600] text-[#1A2434] lg:leading-[43.2px] xl:text-[36px]">Mr. Ramesh Chandra Partani</section>
