  ...
  return (
    <div>
      <section className="pt-6 pb-[52px] bg-[#FAEFB6] rounded-bl-[40px] rounded-br-[40px] px-4 sm:px-16 lg:px-[50px] lg:py-24 lg:rounded-br-[100px] lg:rounded-bl-[100px] xl:px-[100px]">
        <section className="relative w-[191px] text-[28px] font-[700] leading-[36.4px] text-center text-[#4D1435] mx-auto lg:text-[42px] lg:leading-[50.4px]">
          <span className="z-10 relative">About Us</span>
          <svg
            className={`absolute w-[207.08px] h-[60.94px] right-[-57%] top-0 translate-x-[-50%] z-0  ${styles.chalkMark} lg:top-4`}
            viewBox="0 0 345 41"
            fill="none"
